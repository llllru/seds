...
CUDA_VISIBLE_DEVICES="0" python -m torch.distributed.launch --nproc_per_node=1 --master_port 29678 \
...
--output_dir result_eval/eval_h2s_fullpath_gate \
--signbert \
--init_model result_train/h2s_posergbfusion_fullpath_gate_only_lr3e4/pytorch_best_model.bin \
