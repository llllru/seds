...
CUDA_VISIBLE_DEVICES="5,6" python -m torch.distributed.launch --nproc_per_node=2 --master_port 29458 \
...
--output_dir result_train/csl_posergbfusion_fullpath_gate_only_lr3e5 \
