...
CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node=2 --master_port 28461 \
...
--output_dir result_train/h2s_posergbfusion_fullpath_gate_only_lr3e5 \
