...
CUDA_VISIBLE_DEVICES="2,3" python -m torch.distributed.launch --nproc_per_node=2 --master_port 28462 \
...
--output_dir result_train/h2s_posergbfusion_fullpath_gate_only_lr1e4 \
