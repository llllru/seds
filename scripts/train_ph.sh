...
CUDA_VISIBLE_DEVICES="0,3,4" PYTORCH_CUDA_ALLOC_CONF=max_split_size_mb:128 python -m torch.distributed.launch --nproc_per_node=3 --master_port 29558 \
main_task_retrieval.py --do_train --num_thread_reader=64 \
--epochs=200 --batch_size=24 --n_display=10 \
--data_path data_ph \
